...
export default {
    ...
    computed:{
        ...
        // ...mapState({sum:'sum',school:'school',hello:'hello'}),
        //借助mapState生成计算属性，从state中读取数据，（数组写法)
        ...mapState(['sum','school','hello']),
    ...
    methods:{
        ...
        // ...mapActions(['odd','wait']),//方法名要和Actions中的一致
    },
}
</script>
